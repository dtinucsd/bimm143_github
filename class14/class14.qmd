...
The pathway with the most significant "Entities p-value" is the cell cycle. The previous kegg results show also show significant p-values in the cell cycle. Factors that can cause differences is a difference in statistical methods used by the two methods.
